...
export function CreatePostForm() {
  ...
  const [errors, setErrors] = useState<FormError[]>([]);  // ✅ array of ZodIssue
  ...
  if (!validationResult.success) {
    setErrors(validationResult.error.issues); // ✅ now matches FormError[]
    return;
  }
      ...
      >
        <div>
          ...
          <input
            type="file"
            id="image"
            name="image"           // <-- this name is important (used in action)
            accept="image/*"
